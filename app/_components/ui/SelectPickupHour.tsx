...
import { useDateStoreActions, usePickupHour, useStartDate } from "~/stores/date.store";
...
const SelectPickupHour = () => {
  ...
  const schedules = Object.values(SCHEDULES[location.name as LocationNames]) as string[];
