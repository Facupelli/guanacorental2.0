  ...
  return (
        ...
        <div className="mx-auto max-w-[70ch] py-8">
          <div className="grid gap-6">
            ...
            <p>
              ...
              Service. * Company (referred to as either &quotthe Company&quot,
              &quotWe&quot, &quotUs&quot or &quotOur&quot in this Agreement)
              refers to Guanaco Rental, Las Palmas Norte 135. * Cookies are
              ...
              Argentina * Device means any device that can access the Service
              such as a computer, a cellphone or a digital tablet. * Personal
              ...
              the duration of a page visit). * Website refers to Guanaco Rental,
              accessible from <a href="https://www.guanacorental.shop/">link</a>
    ...
    flash.html#main_Where_can_I_change_the_settings_for_disabling__or_deleting_local_shared_objects_"
              ...
              * Web Beacons. Certain sections of our Service and our emails may
              ...
              verifying system and server integrity). Cookies can be
              &quotPersistent&quot or &quotSession&quot Cookies. Persistent
              ...
              template/#Use_Of_Cookies_And_Tracking) article. We use both
              ...
              Cookies Type: Persistent Cookies Administered by: Us Purpose:
            ...
            <p>
              ...
              communication, such as a mobile application&aposs push
              ...
              such information. * To manage Your requests: To attend and manage
              Your requests to Us. * For business transfers: We may use Your
              ...
              contact You. * For business transfers: We may share or transfer
              ...
              publicly distributed outside. * With Your consent : We may
            ...
            <p>
              ...
              and becomes subject to a different Privacy Policy. Law enforcement
              ...
              court or a government agency). Other legal requirements
            ...
            <p>
              ...
              a parent, We may require Your parent&aposs consent before We
            ...
            <p>
              ...
              &quotLast updated&quot date at the top of this Privacy Policy. You
            ...
            <p>
              ...
              contact us: * By email: hello@guanacorental.com
            </p>
          </div>
        </div>
      </main>
